# check_es_meta - This function checks whether expected hosts are found in the Elasticsearch meta data(day before yesterday).
...
#                  of hosts that were found in Elasticsearch but are absent from the configurations(assumingly, from others' configurations).
#
